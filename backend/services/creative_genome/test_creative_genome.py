...
from backend.services.creative_genome.genome_extractor import GenomeExtractor
from backend.services.creative_genome.persuasion_classifier import PersuasionClassifier
from backend.services.creative_genome.structure_analyzer import StructureAnalyzer
from backend.services.creative_genome.genome_vectorizer import GenomeVectorizer
from backend.services.creative_genome.genome_cluster_engine import GenomeClusterEngine
from backend.services.creative_genome.creative_archetype_builder import CreativeArchetypeBuilder
from backend.services.creative_genome.creative_strategy_engine import CreativeStrategyEngine
from backend.services.creative_genome.models import CreativeStrategySignal
...
@pytest.fixture
def ce():
    import backend.services.creative_genome.genome_cluster_engine as mod
    mod._clusters.clear()
...
@pytest.fixture
def ab(ce):
    import backend.services.creative_genome.creative_archetype_builder as mod
