...
from backend.services.competitor.competitor_registry    import CompetitorRegistry
from backend.services.competitor.content_cleaner        import ContentCleaner
from backend.services.competitor.similarity_engine      import SimilarityEngine
...
from backend.services.competitor.embedding_engine       import EmbeddingEngine, _mock_vector
...
def registry():
    ...
    import backend.services.competitor.competitor_registry as mod
    mod._registry = {}
    return r
...
class TestCrawlerEngine:
    ...
    async def test_crawl_returns_list(self):
        from backend.services.competitor.crawler_engine import CrawlerEngine
